...
`,paraId:13,tocIndex:7}]},15004:function(b,l){l.Z=`import React, { useEffect, useState } from 'react';
...
export default Demo;
`},8609:function(b,l){l.Z=`import React, { useEffect, useRef } from 'react';
import DemoImage from './sunflower.jpg';
...
export default Demo;
`},49442:function(b,l){l.Z=`import React, { useEffect, useRef, useState } from 'react';
import { drawPuzzle } from '../util';
...
export default Demo;
`},76542:function(b,l){l.Z=`import React, { useEffect, useRef } from 'react';
...
export default Demo;
`},41269:function(b,l){l.Z=`import { randomInt } from 'ut2';
