...
`,paraId:13,tocIndex:7}]},89182:function(O,l){l.Z=`import React, { useEffect, useState } from 'react';
...
export default Demo;
`},76610:function(O,l){l.Z=`import React, { useEffect, useRef } from 'react';
import DemoImage from './sunflower.jpg';
...
export default Demo;
`},61294:function(O,l){l.Z=`import React, { useEffect, useRef, useState } from 'react';
import { drawPuzzle } from '../util';
...
export default Demo;
`},63346:function(O,l){l.Z=`import React, { useEffect, useRef } from 'react';
...
export default Demo;
`},92951:function(O,l){l.Z=`import { randomInt } from 'ut2';
