...
`,paraId:13,tocIndex:7}]},80583:function(O,l){l.Z=`import React, { useEffect, useState } from 'react';
...
export default Demo;
`},68914:function(O,l){l.Z=`import React, { useEffect, useRef } from 'react';
import DemoImage from './sunflower.jpg';
...
export default Demo;
`},29774:function(O,l){l.Z=`import React, { useEffect, useRef, useState } from 'react';
import { drawPuzzle } from '../util';
...
export default Demo;
`},74207:function(O,l){l.Z=`import React, { useEffect, useRef } from 'react';
...
export default Demo;
`},25119:function(O,l){l.Z=`import { randomInt } from 'ut2';
